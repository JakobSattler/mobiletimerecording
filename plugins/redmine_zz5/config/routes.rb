...
post 'zz5/save_single_worktime', :to => 'workdays#save_single_worktime'
post 'zz5/save_multiple_worktime', :to => 'workdays#save_multiple_worktime'
post 'zz5/delete_worktime', :to => 'workdays#delete_worktime'
post 'zz5/save_absence', :to => 'workdays#save_absence'

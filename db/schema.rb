...
ActiveRecord::Schema.define(:version => 20140920094058) do
  ...
  create_table "zz5_absence_types", :force => true do |t|
    t.string "name"
  end

  create_table "zz5_absences", :force => true do |t|
    t.integer "zz5_workday_id",                                         :null => false
    t.integer "zz5_absence_type_id"
  ...
  create_table "zz5_employments", :force => true do |t|
    t.integer "user_id"
    t.date    "start"
    t.float   "employment",                        :default => 0.0
    t.integer "vacation_entitlement", :limit => 8, :default => 0
    t.integer "time_carry"
    t.boolean "is_all_in"
    t.integer "overtime_allowance",                :default => 0
    t.float   "calculation_rate",                  :default => 1.0
  end

  create_table "zz5_pinned_tickets", :force => true do |t|
    t.integer "user_id"
    t.integer "issue_id"
  end

  create_table "zz5_removed_tickets", :force => true do |t|
    t.integer "user_id"
    t.integer "issue_id"
  end

  create_table "zz5_special_holidays", :force => true do |t|
    t.integer "user_id",                         :null => false
    t.date    "holiday_date"
    t.float   "workday_factor", :default => 0.0
    t.string  "holiday_name",   :default => ""
  end

  add_index "zz5_special_holidays", ["user_id", "holiday_date"], :name => "index_zz5_special_holidays_on_user_id_and_holiday_date", :unique => true

  create_table "zz5_user_preferences", :force => true do |t|
    t.integer "user_id"
    t.time    "work_start",            :default => '2000-01-01 09:00:00'
    t.time    "end_work",              :default => '2000-01-01 17:00:00'
    t.time    "break_duration",        :default => '2000-01-01 00:30:00'
    t.string  "work_days",             :default => "1111100"
    t.integer "favorite_tickets",      :default => 10
    t.integer "display_days",          :default => 5
  ...
  create_table "zz5_workdays", :force => true do |t|
    ...
    t.time    "end"
    t.time    "break"
    t.time    "target",        :default => '2000-01-01 00:00:00'
    t.integer "carry_over",    :default => 0
    t.integer "carry_forward", :default => 0
    t.integer "absences",      :default => 0
  end

  add_index "zz5_workdays", ["user_id", "date"], :name => "index_zz5_workdays_on_user_id_and_date", :unique => true

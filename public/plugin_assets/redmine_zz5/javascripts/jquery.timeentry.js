...
(function($) { // Hide scope, no $ conflict
 ...
 $(selector).timeEntry('setTime', null) */
        ...
        _doKeyDown: function(event) {
            ...
            if (event.keyCode == 8) { // ZZ5 HACK - DON'T ALLOW BACKSPACE OTHERWISE TIME CALCULATIONS MAY GET CORRUPTED!!!
                return false;
            }
        ...
        _setTime: function(inst, time) {
            ...
            if ($.isFunction(inst.options.beforeSetTime)) {
                time = inst.options.beforeSetTime.apply(inst.elem[0], [this.getTime(inst.elem[0]), time, minTime, maxTime]);
                fields[0] = time.getHours();
                fields[1] = time.getMinutes();
                fields[2] = time.getSeconds();
            }
